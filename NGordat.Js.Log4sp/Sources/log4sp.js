...
/**
 * @fileoverview log4sp is a library to log in JavaScript in similar manner 
 * than in log4j for Java. The API should be nearly the same.
 * 
 * This file contains all log4sp code and is the only file required for logging.
 * 
 * <h3>Example:</h3>
 * <pre>
 *  var log = new Log4sp.getLogger("some-category-name"); //create logger instance
 *  log.setLevel(Log4sp.Level.TRACE); //set the Level
 ...
 * @since 2005-05-20
 * @static
 * Website: http://stritti.github.io/log4sp/
 */
var Log4sp = {
	
	/** 
	 * Current version of log4sp. 
	 * @static
	 * @final
	 */
  	version: "1.0.0",
	...
	getLogger: function(categoryName) {
		...
		if (!Log4sp.loggers[categoryName]) {
			// Create the logger for this name if it doesn't already exist
			Log4sp.loggers[categoryName] = new Log4sp.Logger(categoryName);
		}
		
		return Log4sp.loggers[categoryName];
	},
	...
	getDefaultLogger: function() {
		return Log4sp.getLogger("[default]"); 
	},
 ...
 * @private
 */
Log4sp.extend = function(destination, source) {
 ...
 * @private
 */	
Log4sp.bind = function(fn, object) {
  return function() {
